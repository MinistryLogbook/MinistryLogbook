...
import androidx.compose.ui.unit.dp
import app.ministrylogbook.shared.layouts.SwipeableDefaults.AnimationSpec
import app.ministrylogbook.shared.layouts.SwipeableDefaults.StandardResistanceFactor
import app.ministrylogbook.shared.layouts.SwipeableDefaults.VelocityThreshold
import app.ministrylogbook.shared.layouts.SwipeableDefaults.resistanceConfig
...
class SwipeProgress<T>(
    val from: T,
    val to: T, // @FloatRange(from = 0.0, to = 1.0)
    val fraction: Float
) {
