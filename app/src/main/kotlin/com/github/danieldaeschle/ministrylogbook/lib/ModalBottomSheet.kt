...
import androidx.compose.ui.unit.dp
import com.github.danieldaeschle.ministrylogbook.lib.ModalBottomSheetState.Companion.Saver
import com.github.danieldaeschle.ministrylogbook.lib.ModalBottomSheetValue.Expanded
import com.github.danieldaeschle.ministrylogbook.lib.ModalBottomSheetValue.HalfExpanded
import com.github.danieldaeschle.ministrylogbook.lib.ModalBottomSheetValue.Hidden
...
class ModalBottomSheetState @Deprecated(
    ...
    @Deprecated(
        message = "This constructor is deprecated. confirmStateChange has been renamed to " + "confirmValueChange.",
        replaceWith = ReplaceWith(
            "ModalBottomSheetState(" + "initialValue, animationSpec, confirmStateChange, false)"
        )
    )
    @Suppress("Deprecation")
    constructor(
    ...
    internal suspend fun animateTo(
        target: ModalBottomSheetValue, velocity: Float = swipeableState.lastVelocity
    ...
    companion object {
        ...
        ): Saver<ModalBottomSheetState, *> = Saver(save = { it.currentValue }, restore = {
            ModalBottomSheetState(
                initialValue = it,
                animationSpec = animationSpec,
        ...
        @Deprecated(
            ...
            replaceWith = ReplaceWith(
                "Saver(animationSpec, confirmStateChange, " + "skipHalfExpanded)"
            )
        )
        fun Saver(
            animationSpec: AnimationSpec<Float>,
...
fun rememberModalBottomSheetState(
    ...
    return key(initialValue) {
        rememberSaveable(
            initialValue, animationSpec, skipHalfExpanded, confirmValueChange, saver = Saver(
                animationSpec = animationSpec,
                skipHalfExpanded = skipHalfExpanded,
                confirmValueChange = confirmValueChange
            )
...
fun ModalBottomSheetLayout(
    ...
    val anchorChangeHandler = remember(sheetState, scope) {
        ModalBottomSheetAnchorChangeHandler(state = sheetState, animateTo = { target, velocity ->
...
object ModalBottomSheetDefaults {
    ...
    val scrimColor: Color
        @Composable get() = MaterialTheme.colorScheme.onSurface.copy(alpha = 0.32f)
}

private fun ConsumeSwipeWithinBottomSheetBoundsNestedScrollConnection(
    state: SwipeableV2State<*>, orientation: Orientation
